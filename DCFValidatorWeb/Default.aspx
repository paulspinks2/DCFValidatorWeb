...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Draft DCF Schema 1.1.0 Draft 6</h2>
    <p>
        The Draft 1.1.0 Schema used by both Validators is here.
    </p>
    <p>
        <a class="btn btn-default" href="Custom_Files/First%20Hearing%20DCF%20Schema%20110.json">DCF Schema 1.1.0 Draft 6: &raquo;</a>
    </p>
